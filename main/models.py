...
class HomeworkSubmission(models.Model):
    ...
    file = models.FileField(upload_to='homework/', null=False, default='default.pdf', verbose_name='Файл')
...
class Blogs(models.Model):
    ...
    photo=models.ImageField(upload_to= 'blogs_image/',verbose_name='Фотка',blank=True)
    main_text=models.TextField(blank=True, verbose_name='Главный текст')
    file = models.FileField(upload_to='blogs_file/', null=False, verbose_name='Файл(необязательно)',blank=True)
    def __str__(self):
        return self.title
    class Meta:
